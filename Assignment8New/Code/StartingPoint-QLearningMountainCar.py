...
#unitTest = QLearning.QLearningUnittest()
#unitTest.test_2()
...
for trialNumber in range(20000):
    ...
    for i in range(201):
        ...
        action = qlearner.GetAction(currentState, False, learningMode=True, randomActionRate=randomActionRate, actionProbabilityBase=actionProbabilityBase)
...
for runNumber in range(n):
    ...
    for i in range(201):
        ...
        currentState = Assignment7Support.MountainCarObservationToStateSpace(observation)
        observation, reward, isDone, info = env.step(qlearner.GetAction(currentState, True, learningMode=False, randomActionRate=randomActionRate, actionProbabilityBase=actionProbabilityBase))
